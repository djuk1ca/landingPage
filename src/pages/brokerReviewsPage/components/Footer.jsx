...
export default function Footer(){
    ...
    return(
        ...
        <footer className="w-[90%] lg:w-4/5 m-auto flex flex-wrap flex-row gap-6 py-12 text-white justify-between items-center text-center font-thin">
            <div className='m-auto lg:m-0 text-center flex flex-col w-4/5 lg:w-1/5 items-center lg:items-start lg:text-left gap-2'>
