...
export default function Cards(){
    return(
        <div className="block w-full text-center py-16">
            <h2 className='uppercase font-black text-[3.5rem] text-white leading-[2.6rem] py-8'>users that <br /> <span className="text-[#C4CB38]">trust us</span></h2>
            
            <p className='uppercase text-[#DCDCDC] text-[1.1rem] text-md lg:text-sm tracking-wide leading-12 mb-10 lg:mx-96'>
