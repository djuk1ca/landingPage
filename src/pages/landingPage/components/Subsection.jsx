        ...
        <div className="flex flex-wrap w-[90%] md:w-4/5 m-auto py-8 text-white items-center justify-between">
                ...
                <div className="w-full lg:w-[45%] flex flex-col items-center lg:items-end lg:text-right">
                    <div className="w-full lg:w-[80%]">
                        <button onClick={() => setMenuOpen(!menuOpen)} className={`${menuOpen && `rounded-b-none`} w-full cursor-pointer flex items-center justify-between py-2 text-[1.5rem] text-white uppercase font-bold px-4 lg:px-12 bg-gradient-to-b from-[#065967] to-[#dde26e] rounded-lg`}>
                            Report Types
                        ...
                        <ul className={`${menuOpen ? `max-h-screen opacity-100 rounded-t-none` : `max-h-0 opacity-0`} 
                                        transition-all duration-300 overflow-hidden 
                                        px-12 text-center lg:text-left w-full none py-3 font-semibold tracking-wider
                                        bg-gradient-to-t from-[#065967] to-[#dde26e] rounded-b-lg`}>
                ...
                <div className="w-full flex flex-col items-center py-4">
                    <div className="w-[85%] flex justify-center gap-4 items-center">
                        <h1 className="text-[3rem] rotate-6 font-bold text-transparent bg-clip-text bg-gradient-to-t from-[#065967] to-[#dde26e]">1</h1>
                        <p className="text-[1.25rem] lg:text-[2rem] text-white italic">File a report and evidence</p>
                    </div>
                    <div className="w-[85%] flex justify-center gap-4 items-center">
                        <h1 className="text-[3rem] rotate-6 font-bold text-transparent bg-clip-text bg-gradient-to-b from-[#065967] to-[#dde26e]">2</h1>
                        <p className="text-[1.25rem] lg:text-[2rem] text-white italic">We manually review the integrity</p>
                    </div>
                    <div className="w-[85%] flex justify-center gap-4 items-center">
                        <h1 className="text-[3rem] rotate-6 font-bold text-transparent bg-clip-text bg-gradient-to-t from-[#065967] to-[#dde26e]">3</h1>
                        <p className="text-[1.25rem] lg:text-[2rem] text-white italic">Report published to profile</p>
                    </div>
                </div>
        </div>
    )
