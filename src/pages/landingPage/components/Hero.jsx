    ...
    return(
        <div className='w-[90%] lg:w-4/5 m-auto h-screen flex items-center'>
          <div className='flex flex-col w-full h-full justify-center gap-6 lg:gap-0 text-center lg:text-start'>
            ...
            <div className='flex flex-col gap-3 w-full items-center lg:items-start my-4'>
              <h2 className='text-center lg:w-max lg:text-left text-white text-[1.25rem] leading-[1.8rem] font-bold tracking-wide'>
              Bringing balance to the 3PL market, broker transparency is long overdue!
              </h2>
              <h1 className='text-center w-full leading-[1.3rem] lg:max-w-[80%] lg:mb-8 lg:text-left text-white text-[1.1rem] font-light tracking-wide'>
            ...
            <button href='#' className="w-full lg:max-w-max text-[1.1rem] py-4 px-6 lg:px-8 border-[1px] text-[#efed0b] font-thin border-[#efed0b] backdrop-blur-sm uppercase rounded-sm transition duration-300 ease-in-out hover:scale-105" >
