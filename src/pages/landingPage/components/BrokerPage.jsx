...
export default function BrokerPage(){
    return(
        <div className="w-[90%] lg:w-4/5 py-8 m-auto text-center">
            <h1 className="font-bold text-[2.5rem] tracking-wide  text-white">Interactive <span className="text-[#C4CB38]">Broker Profile Page</span> </h1>
