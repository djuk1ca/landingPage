const LoginForm = () => {
    return (
        <div className="z-10 flex justify-center items-center w-screen h-screen">
            <div className="mt-16 lg:w-[28rem] sm:w-4/5 xs:w-full h-[30rem] bg-neutral-200 rounded-[75px] text-center">

                <div className="my-5 mt-10">
                    <h1 className="text-2xl mt-6 font-semibold tracking-wide">Register to BA</h1>
